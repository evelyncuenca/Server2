    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (opcion.equalsIgnoreCase("CONSULTAR_CONTRIBUYENTE")) {
                ...
                String fechaHoraAlta = Long.valueOf(new Date().getTime()).toString();
                String usuarioTerminal = "1";//((UsuarioTerminal) request.getSession().getAttribute("objUsuarioTerminal")).getIdUsuarioTerminal().toString();
                if (contrib != null) {//SI EXISTE EN PRODUCCION
                    ...
                    newContrib.setMesCierre(Integer.valueOf(contrib.getMesCierre()).intValue());
                    newContrib.setModalidadContribuyente(Integer.valueOf(contrib.getModalidad()).intValue());
                    newContrib.setTipoContribuyente(Integer.valueOf(contrib.getTipo()).intValue());
                    ...
                    newContrib.setMesCierre(Integer.valueOf(mesCierre).intValue());
                    newContrib.setModalidadContribuyente(Integer.valueOf(modalidadContribuyente).intValue());
                    newContrib.setTipoContribuyente(Integer.valueOf(tipoContribuyente).intValue());
                ...
                contrib.setMesCierre(Integer.valueOf(mesCierre).intValue());
                contrib.setModalidadContribuyente(Integer.valueOf(modalidadContribuyente).intValue());
                contrib.setTipoContribuyente(Integer.valueOf(tipoContribuyente).intValue());
                contrib.setEstado(estado);
