...
public class PERSONA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String nombres = request.getParameter(PERSONA.NOMBRES) != null && !request.getParameter(PERSONA.NOMBRES).isEmpty() ? request.getParameter(PERSONA.NOMBRES) : null;
            String apellidos = request.getParameter(PERSONA.APELLIDOS) != null && !request.getParameter(PERSONA.APELLIDOS).isEmpty() ? request.getParameter(PERSONA.APELLIDOS) : null;
            ...
            if (opcion.equalsIgnoreCase("AGREGAR")) {
                ...
                if (primerResultado != null && cantResultados != null) {
                    lista = personaFacade.list(persona, Integer.parseInt(primerResultado), Integer.parseInt(cantResultados),true);
                } else {
                    lista = personaFacade.list(persona,true);
                }
                total = personaFacade.total(persona,true);
                JSONObject jsonRespuesta = new JSONObject();
