...
function cabeceraControlFormulariosBoletas(){
    ...
    var nroDeOrden = new Ext.form.NumberField({
        fieldLabel : 'NRO. DE ORDEN',
        name : 'FILTRO_NRO_ORDEN',
        height : '17',
        anchor : '95%',
        allowBlank:false
    });
    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        buttons : [{           
            ...
            handler : function() {
                ...
                Ext.getCmp('gridControlFormulariosBoletas').store.baseParams['FILTRO_NRO_ORDEN'] = nroDeOrden.getValue();
        ...
        items   : [
        {
            ...
            items:[{
                ...
                columnWidth:.5,
                layout: 'form',
                items: [fechaHasta,comboTERMINAL,comboREGISTRO_GESTION, nroDeOrden]
            }]
        },{
            xtype: 'radiogroup',
    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        buttons : [{          
            ...
            handler : function() {
                ...
                Ext.getCmp('gridControlFormularios').store.baseParams['FILTRO_NRO_ORDEN'] = nroDeOrden.getValue();
