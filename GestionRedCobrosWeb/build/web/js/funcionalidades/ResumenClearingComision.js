...
function parametrosResumenClearingComision(){
    ...
    var formPanel = new Ext.FormPanel({
        ...
        monitorValid : true,
        items : [comboRED,comboRECAUDADOR,desde,hasta,formatoDeDescarga],
        buttons : [{
                ...
                if(!trabajando){
                    ...
                    try {
                        ...
                        Ext.DomHelper.append(document.body, {
                            ...
                            src : 'reportes?op=RESUMEN-CLEARING-COMISION&'+'idRed='+comboRED.getValue()+'&idRecaudador='+comboRECAUDADOR.getValue()+'&fechaIni='+desde.getRawValue()+'&fechaFin='+hasta.getRawValue()+'&formatoDescarga='+formatoDeDescarga.getValue()
