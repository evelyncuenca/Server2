 ...
 */
package py.com.documenta.set.pojo.ot.guardar;
...
public class GuardarOTResponse {
    ...
    public String toString() {
        return "GuardarOTResponse{" + "era=" + era + ", numeroDocumento=" + numeroDocumento + ", fechaRecepcion=" + fechaRecepcion + ", identificadorDocumento=" + identificadorDocumento + ", estado=" + estado + ", errores=" + errores + '}';
    }
