                        ...
                        fn : function(btn, text) {
                            ...
                            if (btn == "ok") {
                                ...
                                if(counterTeclasPresionadas == counterConfirmarContrasenha.length){
                                    ...
                                    Ext.Msg.show({
                                        title : 'Atención',
                                        msg : "El campo 'Confirmar Nuevo Password' debe ser cargado sólo desde el teclado, o No coinciden el campo 'Password Nuevo' y el campo 'Confirmar Password Nuevo'.",
                                        buttons : Ext.Msg.OK,
                                        icon : Ext.MessageBox.ERROR
                                    });
                                }
