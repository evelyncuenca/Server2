...
//    }, null,null ) ;
    ...
    var param = new Ext.form.ComboBox({
        fieldLabel: 'OPCION',
        name : 'opcionReporte',
        hiddenName : 'TIPO',
        valueField : 'TIPO',
    ...
    var formPanel = new Ext.FormPanel({
        ...
        monitorValid : true,
        items : [comboRED,comboRECAUDADOR,comboSUCURSAL,comboFACTURADOR,fechaDesde,fechaHasta,param,formatoDeDescarga],
        buttons : [{
                ...
                if(!trabajando){
                    ...
                    try {
                        ...
                        Ext.DomHelper.append(document.body, {
                            ...
                            src : 'reportes?op=REPORTE_RESUMEN_FACTURADOR'+'&idRed='+comboRED.getValue()+'&idFacturador='+comboFACTURADOR.getValue()+'&fechaIni='+fechaDesde.getRawValue()+'&fechaFin='+fechaHasta.getRawValue()+'&idRecaudador='+comboRECAUDADOR.getValue()+'&idSucursal='+comboSUCURSAL.getValue()+'&formatoDescarga='+formatoDeDescarga.getValue()+'&isCorte='+param.getValue()
                        });
                        trabajando = false;
                    } catch (e) {
