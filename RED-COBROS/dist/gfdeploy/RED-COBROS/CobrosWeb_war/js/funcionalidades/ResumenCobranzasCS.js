function pantallaREPORTE_COBRANZA_CS(){
    ...
    var panel = {
        ...
        border : false,
        autoScroll : true ,
        items: [FormPanelResumenCobranzas()]
    }
    //return panel;
    var win = new Ext.Window({
        id : 'idPanelRESUMEN_COBRANZA_CS',
        title:'REPORTE COBRANZA COBRO SERVICIOS',
        width : 'auto',
        height : 'auto',
        modal:true,
        closable : true,
...
function FormPanelResumenCobranzas(){
    ...
    var formPanel = new Ext.FormPanel({
        ...
        items : [{
            ...
            items:[{
                columnWidth:.5,
                layout: 'form',
                items: [comboSUCURSAL,comboUSUARIO,comboTERMINAL,comboFACTURADOR,comboSERVICIO,comboEstadoTransaccion]
            },{
                columnWidth:.5,
                layout: 'form',
                items: [fechaDeIni,fechaDeFin,comboTIPO_CONSULTA,comboREGISTRO_GESTION,comboTIPO_REPORTE, comboTIPO_COBRO, formatoDeDescarga]
            }]
        }],
            ...
            handler : function() {
                ...
                try {
                    ...
                    Ext.DomHelper.append(document.body, {
                        ...
                        src : 'reportes?op='+comboTIPO_COBRO.getValue()+'&idTerminal='+comboTERMINAL.getValue()+'&idSucursal='+comboSUCURSAL.getValue()+'&idUsuario='+comboUSUARIO.getValue()+'&codigoServicio='+comboSERVICIO.getValue()+'&idFacturador='+comboFACTURADOR.getValue()+'&idGestion='+comboREGISTRO_GESTION.getValue()+'&estadoTransaccion='+comboEstadoTransaccion.getValue()+'&fechaFin='+fechaDeFin.getRawValue()+'&fechaIni='+fechaDeIni.getRawValue()+'&formatoDescarga='+formatoDeDescarga.getValue()+'&tipoConsulta='+comboTIPO_CONSULTA.getValue()+'&tipoReporte='+comboTIPO_REPORTE.getRawValue()+'&idSupervisor=1'
                    });
                } catch (e) {
                    alert(e);
                }
