...
function parametrosREPORTE_RECAUDACION(){
    ...
    var formPanel = new Ext.FormPanel({
        ...
        monitorValid : true,
        items : [fechaDesde,fechaHasta,comboRECAUDADOR,comboSUCURSAL,tipoReporte,formatoDeDescarga],
        buttons : [{
                ...
                if(!trabajando){
                    ...
                    try {
                        ...
                        Ext.DomHelper.append(document.body, {
                            ...
                            src : 'reportes?op=RESUMEN_DE_TRANSACCIONES&fechaIni='+fechaDesde.getRawValue()+'&fechaFin='+fechaHasta.getRawValue()+'&idRecaudador='+comboRECAUDADOR.getValue()+'&idSucursal='+comboSUCURSAL.getValue()+'&formatoDescarga='+formatoDeDescarga.getValue()+'&tipoReporte='+tipoReporte.getValue()
                        });
                        trabajando = false;
                    } catch (e) {
