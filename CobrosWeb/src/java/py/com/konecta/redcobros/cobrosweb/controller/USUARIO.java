...
public class USUARIO extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String codigoExterno = request.getParameter(USUARIO.CODIGO_EXTERNO);
            ...
            if (opcion.equalsIgnoreCase("AGREGAR")) {
                ...
                if (nombreUsuario.equals("root")) {
                    ...
                    usuario.setContrasenha(py.com.konecta.redcobros.cobrosweb.utiles.Utiles.getSha1(contrasenha));
                ...
                JSONArray jsonUsuarios = new JSONArray();
                for (Usuario e : lista) {
                    if (e.getRecaudador().getIdRecaudador().equals((Long) request.getSession().getAttribute("idRecaudador"))) {
                    JSONObject jsonUsuario = new JSONObject();
                    jsonUsuario.put(USUARIO.ID_USUARIO, e.getIdUsuario());
                    ...
                    jsonUsuario.put(USUARIO.CODIGO_EXTERNO, e.getCodExterno() != null ? e.getCodExterno() : "");
