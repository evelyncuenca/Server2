        ...
        try {
            ...
            if (opcion.equalsIgnoreCase("LISTAR")) {
                ...
                if (request.getParameter("start") != null && request.getParameter("limit") != null) {
                    ...
                    lista = formContribFacade.getControlFormulario(idRed, idRecaudador, idSucursal, idTerminal, idGestion, recepcionados, todosRecepcionados, controlados, todosControlados, fechaD, fechaH, primerResultado, cantResultados);
                    total = formContribFacade.getTotalControlFormulario(idRed, idRecaudador, idSucursal, idTerminal, idGestion, recepcionados, todosRecepcionados, controlados, todosControlados, fechaD, fechaH);
                ...
                if (request.getParameter("start") != null && request.getParameter("limit") != null) {
                    ...
                    Date fechaD = new Date();
                    Date fechaH = new Date();
                    lista = transaccionFacade.getControlFormularioBoletas(idRed, idRecaudador, idSucursal, idTerminal, idGestion, filtroCheque, filtroEfectivo, todosFormaPago, fechaD, fechaH, filtroAceptado, filtroRechazados, todosAceptadosRechazados, primerResultado, cantResultados);

                    total = transaccionFacade.getTotalControlFormularioBoletas(idRed, idRecaudador, idSucursal, idTerminal, idGestion, filtroCheque, filtroEfectivo, todosFormaPago, filtroAceptado, filtroRechazados, todosAceptadosRechazados, fechaD, fechaH);
                    JSONObject jsonRespuesta = new JSONObject();
                    JSONArray json = new JSONArray();
                ...
                /*
                 * if (rechazado.equalsIgnoreCase("N") ||
                 * rechazado.equalsIgnoreCase("S")) { //
                 * entidad.setRechazado(rechazado.toUpperCase()); }
                 */
                JSONObject jsonRespuesta = new JSONObject();
                if (entidad.getMigrado() == null || entidad.getMigrado() != 'S') {
                    if (enviado.equalsIgnoreCase("N") && !((entidad.getEnviado() != null) && entidad.getEnviado().equalsIgnoreCase("N"))) {
                        entidad.setEnviado(enviado.toUpperCase());
                    } else if (enviado.equalsIgnoreCase("S") && !((entidad.getEnviado() != null) && entidad.getEnviado().equalsIgnoreCase("S"))) {
                        entidad.setEnviado(enviado.toUpperCase());
                    ...
                    jsonRespuesta.put("success", false);
                    jsonRespuesta.put("motivo", "No se puede anular. Formulario ya migrado");
                }
                ...
                if (entidad.getMigrado() == null || entidad.getMigrado() != 'S') {
                    ...
                    jsonRespuesta.put("success", false);
                    jsonRespuesta.put("motivo", "No se puede anular. Transaccion ya migrada");
                }
                out.println(jsonRespuesta.toString());
                ...
                jsonDetalle.put(CONTROL_FORMULARIOS.NUMERO_OT, entity.getBoletaPagoContrib().getNumeroOt());
...
//                jsonDetalle.put(CONTROL_FORMULARIOS.ID_BANCO, (entity.getTransaccion() != null && entity.getTransaccion().getEntidadFinanciera() != null) ? entity.getTransaccion().getEntidadFinanciera().getIdEntidadFinanciera() : "-");
                ...
                jsonDetalle.put(CONTROL_FORMULARIOS.NUMERO_OT, (entity.getTransaccion() != null && entity.getTransaccion().getBoletaPagoContrib() != null) ? entity.getTransaccion().getBoletaPagoContrib().getNumeroOt() : "-");
