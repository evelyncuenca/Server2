...
public class USUARIOS_ROLES extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op.equalsIgnoreCase("LISTAR")) {
            ...
            if ((request.getParameter("ROLES") != null) && (request.getParameter("ROLES").matches("[0-9]+")) && (request.getParameter("CONF_USUARIO") != null) && (request.getParameter("CONF_USUARIO").matches("[0-9]+"))) {
                /**********************************************************************/
                try {
                    Usuario usuario = usuarioFacade.get(new Long(request.getParameter("CONF_USUARIO")));
