    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (opcion.equalsIgnoreCase("AGREGAR")) {
                ...
                franjaHorariaCab.setComentario(comentario);
                franjaHorariaCab.setDescripcion(descripcion);
                franjaHorariaCab.setRecaudador(new Recaudador((Long)session.getAttribute("idRecaudador")));
                //  franjaHorariaCab.setIdFranjaHorariaCab(new Long(idFranjaHorariaCab));
                ...
                if (primerResultado != null && cantResultados != null) {
                    lista = franjaHorariaCabFacade.list(franjaHorariaCab, Integer.parseInt(primerResultado), Integer.parseInt(cantResultados));
                } else {
                    lista = franjaHorariaCabFacade.list(franjaHorariaCab);
                }
                total = franjaHorariaCabFacade.total(franjaHorariaCab);
                JSONObject jsonRespuesta = new JSONObject();
