...
function pantallaREPORTE_RESUMEN_FACTURADOR_GESTION(){
    var panel = {
        xtype : 'panel',
        layout : 'fit',
        border : false,
        autoScroll : true ,
        items: [parametrosResumenFacturadorGestion()]
    };
    var win = new Ext.Window({
        id : 'idPanelREPORTE_RESUMEN_FACTURADOR_GESTION',
...
function parametrosResumenFacturadorGestion(){
...
//    }, null,null ) ;
    ...
    var formPanel = new Ext.FormPanel({
        ...
        monitorValid : true,
        items : [comboRED,comboRECAUDADOR,comboSUCURSAL,comboFACTURADOR,fechaDesde,fechaHasta,formatoDeDescarga],
        buttons : [{
                ...
                if(!trabajando){
                    ...
                    try {
                        ...
                        Ext.DomHelper.append(document.body, {
                            ...
                            src : 'reportes?op=REPORTE_RESUMEN_FACTURADOR'+'&Ges=true'+'&idRed='+comboRED.getValue()+'&idFacturador='+comboFACTURADOR.getValue()+'&fechaIni='+fechaDesde.getRawValue()+'&fechaFin='+fechaHasta.getRawValue()+'&idRecaudador='+comboRECAUDADOR.getValue()+'&idSucursal='+comboSUCURSAL.getValue()+'&formatoDescarga='+formatoDeDescarga.getValue()
                        });
                        trabajando = false;
                    } catch (e) {
